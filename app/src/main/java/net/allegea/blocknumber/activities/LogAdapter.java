    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        deleteButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialog.setMessage("Are you sure you want to delete this fromg your log?");
                dialog.setButton(DialogInterface.BUTTON_POSITIVE, "Yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        LogActivity.deleteFromLog(blockedActivity, position);
                    }
                });
        ...
        if (blockedActivity.getTitle().startsWith("Message")) {
            ...
            actionButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    LogActivity.call(blockedActivity.getNumber());
                }
            });
        }
        return vi;
